...
return [
    ...
    'public_user_index' => [[], ['_controller' => 'App\\Controller\\Account\\UserPublicController::index'], [], [['text', '/public/user/']], [], [], []],
    'public_user_new' => [[], ['_controller' => 'App\\Controller\\Account\\UserPublicController::new'], [], [['text', '/public/user/new']], [], [], []],
    'public_user_show' => [['id'], ['_controller' => 'App\\Controller\\Account\\UserPublicController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/public/user']], [], [], []],
